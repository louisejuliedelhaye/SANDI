...
***Disclaimer**: This is an alpha version of the software, and it may therefore still contain some errors or malfunctions. In the TODO.md document, you can see the improvements planned for the future versions of the software, but any additional feedback or suggestion is welcome and appreciated, as we hope to make it a collaboratively improving tool.*
