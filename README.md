...
## Known issue
For certain types of images, you might experience an issue with the vignette export in the single image processing page if you don't previously apply a resampling on the image. We are aware of this issue and are currently working on resolving it. Know you should be able to export the correct vignettes when applying the resampling. Sorry for the inconvenience.
