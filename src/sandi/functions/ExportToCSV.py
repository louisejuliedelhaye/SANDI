            ...
            with open(file_path, 'w', newline='', encoding='utf-8') as csvfile:
                ...
                for i, prop in enumerate(stats):
                    ...
                    particle_data = {
                        ...
                        "Max Intensity": prop.max_intensity_original,
                        "Min Intensity": prop.min_intensity_original,
                        "Mean Intensity": prop.mean_intensity_original,
...
def save_image_csv(stats, file_path, app_instance):        
    ...
    if stats:
        ...
        if file_path:
           ...
           "Mean Minor-Axis-Length (um)", "Mean Feret (um)", "Number of Particles", "Mean Area (um²)", "Mean Perimeter (um)", "Mean Diameter (um)", "Sauter Diameter (um)", "Mean Specific Surface Area (um-1)", "Mean Mean Intensity", "Mean Kurtosis", "Mean Skewness",
           "Total Volume Concentration (ul/l)","1.21449578", "1.60249025", "1.891035166", "2.23134399", "2.633450968", "3.107850704", "3.666961685", "4.327133347", "5.106510257", "6.025832888", 
                ...
                image_data = {
                    ...
                    "Sauter Diameter (um)": IMG.Sauter_diameter,
                    "Mean Specific Surface Area (um-1)": IMG.SSA,
