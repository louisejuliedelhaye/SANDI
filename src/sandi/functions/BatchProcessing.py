        ...
        try:
            with open(os.path.join(csv_file_path, "batch_statistics.csv"), mode='a', newline='', encoding='utf-8') as csvfile:
                fieldnames = [
                    ...
                    "Mean Diameter (um)", "Sauter Diameter (um)", "Mean Specific Surface Area (um-1)", "Mean Mean Intensity", "Mean Kurtosis", "Mean Skewness", "Total Volume Concentration (ul/l)", "1.21449578", "1.60249025", "1.891035166", "2.23134399", "2.633450968", "3.107850704", "3.666961685", "4.327133347", "5.106510257", "6.025832888", 
